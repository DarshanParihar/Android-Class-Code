package com.example.spinnerautocompletedemo;
...
public class MainActivity extends Activity implements OnItemSelectedListener {
	...
	public void onItemSelected(AdapterView<?> adapterView, View view,
		...
		if (countryAdapter.getItem(position).contains("India"))
			imgCountryFlag.setImageResource(R.drawable.india);
		else if (countryAdapter.getItem(position).contains("USA"))
			imgCountryFlag.setImageResource(R.drawable.usa);
		else if (countryAdapter.getItem(position).contains("England"))
			imgCountryFlag.setImageResource(R.drawable.uk);
	}
